...
grey_seal_meta <- read_excel("/Users/morganmccarthy/Documents/Manuscripts/2022/Grey seal/ddRAD/Figures and Tables/grey_seal_meta.xlsx")
mapping_stats <- read_excel("/Users/morganmccarthy/Documents/Manuscripts/2022/Grey seal/ddRAD/Figures and Tables/mapping.stats.xlsx")
depth_of_3_wo_harbour_seals_outliers <- read.table("~/Documents/Manuscripts/2022/Grey seal/ddRAD/Figures and Tables/depth_of_3_wo_harbour_seals_outliers_bam_list", quote="\"", comment.char="")
...
#This step removes all samples from the Shetland Islands
depth_with_metadata <- depth_with_metadata %>%
  filter(Local8 != "Shetland") %>%
  filter(Local8 != "Gulf of St Lawrence")
```
